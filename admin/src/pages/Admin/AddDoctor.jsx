...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <p className='mb-3 text-lg font-medium'>Add Service Provider</p>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    ...
                    <p>Upload Service Provider<br /> picture</p>
                </div>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="Car Machanics">Car Machanics</option>
                ...
                <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full'>Add service provider and doctor</button>
